        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousBuyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    ReservedForUserId = table.Column<int>(type: "int", nullable: true),
                    ReservationExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsOwnedByCurrentUser = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaitingList", x => x.WaitingListId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WaitingList_UserAccounts_UserId",
                        column: x => x.UserId,
                        principalTable: "UserAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
